...
var SuggestionsOverlay = function(_Component) {
  ...
  return _createClass(SuggestionsOverlay, [ {
    ...
    value: function() {
      ...
      }, style("list")), this.renderLoadingIndicator(), this.renderSuggestions())) : null;
    }
  }, {
    ...
    value: function() {
      if (this.props.isLoading) return this.props.loader() || React__default.createElement(LoadingIndicator, {
...
var getComputedStyleLengthProp = function(forElement, propertyName) {
  ...
  var display = _ref.display, id = _ref.id, style = _ref.style, className = _ref.className, classNames = _ref.classNames, render = _ref.render;
  if (render) return render(id, display);
